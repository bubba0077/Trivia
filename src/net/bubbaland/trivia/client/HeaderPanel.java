...
public class HeaderPanel extends TriviaPanel implements ActionListener {
	...
	public HeaderPanel(TriviaInterface server, TriviaClient client) {
		...
		this.enclosedLabel(client.getTrivia().getTeamName(), COL3_WIDTH, TOP_ROW_HEIGHT, LABEL_COLOR,
				BACKGROUND_COLOR, constraints, LABEL_FONT_SIZE, SwingConstants.CENTER, SwingConstants.CENTER);
		constraints.weightx = 0.0;

		constraints.gridx = 4;
		constraints.gridy = 0;
		constraints.gridwidth = 2;
		this.enclosedLabel("Last Round ", COL4_WIDTH, TOP_ROW_HEIGHT, ANNOUNCED_COLOR, BACKGROUND_COLOR,
		...
		this.roundEarnedLabel = this.enclosedLabel("", COL1_WIDTH, MIDDLE_ROW_HEIGHT, EARNED_COLOR,
				BACKGROUND_COLOR, constraints, POINT_FONT_SIZE, SwingConstants.RIGHT, SwingConstants.CENTER);
		...
		constraints.gridx = 4;
		constraints.gridy = 1;
		this.enclosedLabel("Points ", COL4_WIDTH, MIDDLE_ROW_HEIGHT, ANNOUNCED_COLOR, BACKGROUND_COLOR,
				constraints, LABEL_FONT_SIZE, SwingConstants.RIGHT, SwingConstants.CENTER);
		...
		constraints.gridx = 0;
		constraints.gridy = 2;
		this.enclosedLabel("Possible", COL0_WIDTH, BOTTOM_ROW_HEIGHT, VALUE_COLOR, BACKGROUND_COLOR,
				constraints, LABEL_FONT_SIZE, SwingConstants.RIGHT, SwingConstants.CENTER);
...
//		this.speedButton.setOpaque(true);
		...
		constraints.gridx = 4;
		constraints.gridy = 2;
		this.enclosedLabel("Place ", COL4_WIDTH, BOTTOM_ROW_HEIGHT, ANNOUNCED_COLOR, BACKGROUND_COLOR,
				constraints, LABEL_FONT_SIZE, SwingConstants.RIGHT, SwingConstants.CENTER);
