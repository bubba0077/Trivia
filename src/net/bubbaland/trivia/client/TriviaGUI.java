...
public class TriviaGUI implements WindowListener {
	...
	final static private String	SETTINGS_VERSION	= "11";
	...
	/**
	 * Entry point for the client application. Only the first argument is used. If the first argument is "useFX",
	 * the client will include an IRC client panel.
	 * 
	 * @param args
	...
	/**
	 * Register a window as a child of the client. New Trivia Frames do this so the client can track events from
	 * them.
	 * 
	 * @param frame
	 *            The window to track
